...
import com.example.hitungbmi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun hitungBmi() {
        ...
        if (TextUtils.isEmpty(berat)) {
            Toast.makeText(this,R.string.berat_invalid,
        ...
        if (TextUtils.isEmpty(tinggi)) {
            Toast.makeText(this, R.string.tinggi_invalid,
                Toast.LENGTH_LONG).show()
            return
        }
        ...
        if (selectedId == -1) {
            Toast.makeText(this, R.string.gender_invalid,
                Toast.LENGTH_LONG).show()
            return
        }
